...
<body>
        ...
        background-size: cover;" class="col-md-10 column-1">
            ...
            <div style="margin: 0 0 0 0;bottom: 0;position: absolute;height: 175px;" class="row">
                ...
                <div class="col-lg-5 column-1">
                    <div class="carousel-item" style="display: block">
                        <img id="avt" style="border: 2px solid white;border-radius: 100%;width: 175px;height: 175px;" src="{{ $infor[0]->Avt }}" class="" alt="">

                    </div>
                </div>
                <div class="col-md-7 column-2">
                    <h3 style="color: white;bottom: 0;padding-top: 35%;padding-left: 5px;">{{ $infor[0]->name }}</h3>
                </div>
            ...
            <div style="margin: 0 0 0 0;bottom: 0;position: absolute;right: 0;" class="row">
                <div class="col-md-12 column-1" style="">
                    @if (session('ID'))
                    <button type="button" onclick="addFriend()" class="btn btn-primary"><i style="margin-right: 7px;" class="fas fa-user-plus"></i>Thêm bàn bè</button>

                    @else
                    <button type="button" onclick="window.location='/FLRV-CH/account'" class="btn btn-primary"><i style="margin-right: 7px;" class="fas fa-user-plus"></i>Thêm bàn bè</button>
    ...
    <div id="rqFriend" style="transition: all-in-ease 1s;" class="modalChangeA">
        ...
        $('.file-upload-content').hide();
            ...
            function addFriend(){
                $.ajax({
                    ...
                    success: function (data) {
                        if(data!=''){
                            $('#rqFriend h3').html('<i class="fas fa-american-sign-language-interpreting">'+data+'</i>');
                            $('#rqFriend').css('display', 'block').delay(100).fadeIn(1500).css('display', 'none').fadeOut(400);
                            $('#rqFriend').css('display', 'none');
                        }
                    }
                });
            }
